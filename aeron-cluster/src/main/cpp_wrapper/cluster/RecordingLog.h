...
/**
 * A log of recordings which make up the history of a Raft log across leadership
 * terms.
 */
class RecordingLog {
public:
  ...
  public:
    ...
    Entry(std::int64_t recordingId, std::int64_t leadershipTermId,
          std::int64_t termBaseLogPosition, std::int64_t logPosition,
          std::int64_t timestamp, std::int32_t serviceId, std::int32_t type,
          const std::string &archiveEndpoint, bool isValid,
          std::int64_t position, std::int32_t entryIndex);
  ...
  public:
    ...
    Snapshot(std::int64_t recordingId, std::int64_t leadershipTermId,
             std::int64_t termBaseLogPosition, std::int64_t logPosition,
  ...
  public:
    ...
    Log(std::int64_t recordingId, std::int64_t leadershipTermId,
        std::int64_t termBaseLogPosition, std::int64_t logPosition,
        std::int64_t startPosition, std::int64_t stopPosition,
        std::int32_t initialTermId, std::int32_t termBufferLength,
        std::int32_t mtuLength, std::int32_t sessionId);
  ...
  public:
    ...
    RecoveryPlan(std::int64_t lastLeadershipTermId,
                 std::int64_t lastTermBaseLogPosition,
                 std::int64_t appendedLogPosition,
                 std::int64_t committedLogPosition,
  ...
  static constexpr std::int32_t LEADERSHIP_TERM_ID_OFFSET =
      RECORDING_ID_OFFSET + static_cast<std::int32_t>(sizeof(std::int64_t));
  static constexpr std::int32_t TERM_BASE_LOG_POSITION_OFFSET =
      LEADERSHIP_TERM_ID_OFFSET +
      static_cast<std::int32_t>(sizeof(std::int64_t));
  static constexpr std::int32_t LOG_POSITION_OFFSET =
      TERM_BASE_LOG_POSITION_OFFSET +
      static_cast<std::int32_t>(sizeof(std::int64_t));
  static constexpr std::int32_t TIMESTAMP_OFFSET =
      LOG_POSITION_OFFSET + static_cast<std::int32_t>(sizeof(std::int64_t));
  static constexpr std::int32_t SERVICE_ID_OFFSET =
      TIMESTAMP_OFFSET + static_cast<std::int32_t>(sizeof(std::int64_t));
  static constexpr std::int32_t ENTRY_TYPE_OFFSET =
      SERVICE_ID_OFFSET + static_cast<std::int32_t>(sizeof(std::int32_t));
  static constexpr std::int32_t ENDPOINT_OFFSET =
      ENTRY_TYPE_OFFSET + static_cast<std::int32_t>(sizeof(std::int32_t));
  static constexpr std::int32_t MAX_ENTRY_LENGTH = 4096;
  static constexpr std::int32_t MAX_ENDPOINT_LENGTH =
      MAX_ENTRY_LENGTH - ENDPOINT_OFFSET -
  ...
  RecoveryPlan createRecoveryPlan(std::shared_ptr<AeronArchive> archive,
                                  std::int32_t serviceCount,
                                  std::int64_t replicatedRecordingId);
  bool isUnknown(std::int64_t leadershipTermId) const;
  void appendTerm(std::int64_t recordingId, std::int64_t leadershipTermId,
                  std::int64_t termBaseLogPosition, std::int64_t timestamp);
  void appendSnapshot(std::int64_t recordingId, std::int64_t leadershipTermId,
                      std::int64_t termBaseLogPosition,
                      std::int64_t logPosition, std::int64_t timestamp,
                      std::int32_t serviceId);
  void appendStandbySnapshot(std::int64_t recordingId,
                             std::int64_t leadershipTermId,
                             std::int64_t termBaseLogPosition,
                             std::int64_t logPosition, std::int64_t timestamp,
                             std::int32_t serviceId,
                             const std::string &archiveEndpoint);
  void commitLogPosition(std::int64_t leadershipTermId,
                         std::int64_t logPosition);
  ...
  latestStandbySnapshots(std::int32_t serviceCount);
  void ensureCoherent(std::int64_t recordingId,
                      std::int64_t initialLogLeadershipTermId,
                      std::int64_t initialTermBaseLogPosition,
                      std::int64_t leadershipTermId,
                      std::int64_t termBaseLogPosition,
                      std::int64_t logPosition, std::int64_t nowNs,
                      std::int64_t timestamp, std::int32_t fileSyncLevel);

  static std::string typeAsString(std::int32_t type);
  static void addSnapshots(std::vector<Snapshot> &snapshots,
  ...
  static bool matchesEntry(const Entry &entry, std::int64_t leadershipTermId,
                           std::int64_t termBaseLogPosition,
                           std::int64_t logPosition, std::int32_t serviceId);
...
private:
  ...
  bool restoreInvalidSnapshot(std::int32_t snapshotEntryType,
                              std::int64_t recordingId,
                              std::int64_t leadershipTermId,
                              std::int64_t termBaseLogPosition,
                              std::int64_t logPosition, std::int64_t timestamp,
                              std::int32_t serviceId);
  std::int32_t append(std::int32_t entryType, std::int64_t recordingId,
                      std::int64_t leadershipTermId,
                      std::int64_t termBaseLogPosition,
                      std::int64_t logPosition, std::int64_t timestamp,
                      std::int32_t serviceId, const std::string &endpoint);
  void persistToStorage(std::int64_t entryPosition, std::int32_t offset,
                        std::int32_t length);
  ...
  static void planRecovery(std::vector<Snapshot> &snapshots,
  ...
  std::unordered_map<std::int64_t, std::int32_t>
      m_cacheIndexByLeadershipTermIdMap;
...
inline RecordingLog::Entry::Entry(
    std::int64_t recordingId, std::int64_t leadershipTermId,
    std::int64_t termBaseLogPosition, std::int64_t logPosition,
    std::int64_t timestamp, std::int32_t serviceId, std::int32_t type,
    const std::string &archiveEndpoint, bool isValid, std::int64_t position,
    std::int32_t entryIndex)
    : recordingId(recordingId), leadershipTermId(leadershipTermId),
      termBaseLogPosition(termBaseLogPosition), logPosition(logPosition),
      timestamp(timestamp), serviceId(serviceId), type(type),
...
inline RecordingLog::Entry::Entry(
    ...
    std::int64_t termBaseLogPosition, std::int64_t logPosition,
    std::int64_t timestamp, std::int32_t serviceId, std::int32_t type,
    const std::string &archiveEndpoint, bool isValid, std::int32_t entryIndex)
    : Entry(recordingId, leadershipTermId, termBaseLogPosition, logPosition,
            timestamp, serviceId, type, archiveEndpoint, isValid,
            aeron::NULL_VALUE, entryIndex) {}

inline std::int32_t RecordingLog::Entry::length() const {
  const std::int32_t unalignedLength =
      (ENTRY_TYPE_STANDBY_SNAPSHOT == type)
          ? (ENDPOINT_OFFSET + static_cast<std::int32_t>(sizeof(std::int32_t)) +
             static_cast<std::int32_t>(archiveEndpoint.length()))
          : ENDPOINT_OFFSET;
  return static_cast<std::int32_t>(
      BitUtil::align(static_cast<std::int64_t>(unalignedLength),
                     static_cast<std::int64_t>(RECORD_ALIGNMENT)));
}

inline RecordingLog::Entry RecordingLog::Entry::invalidate() const {
  return Entry(recordingId, leadershipTermId, termBaseLogPosition, logPosition,
               timestamp, serviceId, type, archiveEndpoint, false, position,
               entryIndex);
}

inline RecordingLog::Entry
RecordingLog::Entry::withLogPosition(std::int64_t newLogPosition) const {
  return Entry(recordingId, leadershipTermId, termBaseLogPosition,
               newLogPosition, timestamp, serviceId, type, archiveEndpoint,
               isValid, position, entryIndex);
}
...
inline bool RecordingLog::Entry::operator==(const Entry &other) const {
  return recordingId == other.recordingId &&
         ...
         logPosition == other.logPosition && timestamp == other.timestamp &&
         serviceId == other.serviceId && type == other.type &&
         entryIndex == other.entryIndex && isValid == other.isValid;
}

inline std::string RecordingLog::Entry::toString() const {
  return std::string("Entry{") + "recordingId=" + std::to_string(recordingId) +
         ...
         ", isValid=" + (isValid ? "true" : "false") + ", archiveEndpoint='" +
         archiveEndpoint + "'" + "}";
}

// Implementation - Snapshot class
inline RecordingLog::Snapshot::Snapshot(std::int64_t recordingId,
                                        std::int64_t leadershipTermId,
                                        std::int64_t termBaseLogPosition,
                                        std::int64_t logPosition,
                                        std::int64_t timestamp,
    ...
    : recordingId(recordingId), leadershipTermId(leadershipTermId),
      termBaseLogPosition(termBaseLogPosition), logPosition(logPosition),
      timestamp(timestamp), serviceId(serviceId) {}
...
inline RecordingLog::Log::Log(
    ...
    : recordingId(recordingId), leadershipTermId(leadershipTermId),
      termBaseLogPosition(termBaseLogPosition), logPosition(logPosition),
      startPosition(startPosition), stopPosition(stopPosition),
      initialTermId(initialTermId), termBufferLength(termBufferLength),
      mtuLength(mtuLength), sessionId(sessionId) {}

inline std::string RecordingLog::Log::toString() const {
  return std::string("Log{") + "recordingId=" + std::to_string(recordingId) +
         ", leadershipTermId=" + std::to_string(leadershipTermId) +
         ", termBaseLogPosition=" + std::to_string(termBaseLogPosition) +
         ", logPosition=" + std::to_string(logPosition) +
...
inline RecordingLog::RecoveryPlan::RecoveryPlan(
    std::int64_t lastLeadershipTermId, std::int64_t lastTermBaseLogPosition,
    std::int64_t appendedLogPosition, std::int64_t committedLogPosition,
    const std::vector<Snapshot> &snapshots, std::shared_ptr<Log> log)
    : lastLeadershipTermId(lastLeadershipTermId),
      ...
      committedLogPosition(committedLogPosition), snapshots(snapshots),
      log(log) {}

inline std::string RecordingLog::RecoveryPlan::toString() const {
  std::string result =
      std::string("RecoveryPlan{") +
...
inline RecordingLog::RecordingLog(const std::string &parentDir, bool createNew)
  ...
  // Simple file existence check - in a real implementation, use
...
inline RecordingLog::~RecordingLog() { close(); }
...
inline void RecordingLog::force(std::int32_t fileSyncLevel) {
  if (fileSyncLevel > 0 && m_fileStream.is_open()) {
    m_fileStream.flush();
    if (fileSyncLevel > 1) {
      // On Windows, we can't easily sync directory, but flush should be
      // sufficient On Unix, we would call fsync
    }
  }
}
...
inline bool RecordingLog::isValidSnapshot(const Entry &entry) {
  return (ENTRY_TYPE_SNAPSHOT == entry.type ||
          ENTRY_TYPE_STANDBY_SNAPSHOT == entry.type) &&
         entry.isValid;
}
...
inline bool RecordingLog::matchesEntry(const Entry &entry,
                                       std::int64_t leadershipTermId,
                                       std::int64_t termBaseLogPosition,
                                       std::int64_t logPosition,
                                       std::int32_t serviceId) {
...
inline void RecordingLog::reload() {
  ...
  for (std::size_t i = 0; i < m_entriesCache.size(); i++) {
    ...
    if (isValidTerm(entry)) {
      m_cacheIndexByLeadershipTermIdMap[entry.leadershipTermId] =
...
inline RecordingLog::Entry
RecordingLog::getTermEntry(std::int64_t leadershipTermId) const {
...
inline RecordingLog::Entry *
RecordingLog::findTermEntry(std::int64_t leadershipTermId) {
  auto it = m_cacheIndexByLeadershipTermIdMap.find(leadershipTermId);
  if (it != m_cacheIndexByLeadershipTermIdMap.end()) {
    return &m_entriesCache[it->second];
  }
...
inline bool RecordingLog::isUnknown(std::int64_t leadershipTermId) const {
  return m_cacheIndexByLeadershipTermIdMap.find(leadershipTermId) ==
         m_cacheIndexByLeadershipTermIdMap.end();
}

inline void RecordingLog::appendTerm(std::int64_t recordingId,
                                     std::int64_t leadershipTermId,
                                     std::int64_t termBaseLogPosition,
                                     std::int64_t timestamp) {
  ...
  if (!m_entriesCache.empty()) {
    ...
    if (m_cacheIndexByLeadershipTermIdMap.find(previousLeadershipTermId) !=
        m_cacheIndexByLeadershipTermIdMap.end()) {
  ...
  const std::int32_t index = append(
      ENTRY_TYPE_TERM, recordingId, leadershipTermId, termBaseLogPosition,
      logPosition, timestamp, aeron::NULL_VALUE, "");

  m_cacheIndexByLeadershipTermIdMap[leadershipTermId] = index;
}

inline void RecordingLog::appendSnapshot(std::int64_t recordingId,
                                         std::int64_t leadershipTermId,
                                         std::int64_t termBaseLogPosition,
                                         std::int64_t logPosition,
                                         std::int64_t timestamp,
  ...
  if (!restoreInvalidSnapshot(ENTRY_TYPE_SNAPSHOT, recordingId,
                              leadershipTermId, termBaseLogPosition,
                              logPosition, timestamp, serviceId)) {
    append(ENTRY_TYPE_SNAPSHOT, recordingId, leadershipTermId,
           termBaseLogPosition, logPosition, timestamp, serviceId, "");
  }
}
...
inline void RecordingLog::appendStandbySnapshot(
  ...
  if (!restoreInvalidSnapshot(ENTRY_TYPE_STANDBY_SNAPSHOT, recordingId,
                              leadershipTermId, termBaseLogPosition,
                              logPosition, timestamp, serviceId)) {
    append(ENTRY_TYPE_STANDBY_SNAPSHOT, recordingId, leadershipTermId,
           termBaseLogPosition, logPosition, timestamp, serviceId,
           archiveEndpoint);
  }
}
...
inline std::int32_t RecordingLog::captureEntriesFromBuffer(
  ...
  while (consumed + ENDPOINT_OFFSET < length) {
    ...
    const std::int32_t entryType =
        buffer.getInt32(consumed + ENTRY_TYPE_OFFSET);
    ...
    if (ENTRY_TYPE_STANDBY_SNAPSHOT == type &&
        (endPointOffset + SIZE_OF_INT > length ||
         endPointOffset + SIZE_OF_INT + buffer.getInt32(endPointOffset) >
             length)) {
      break;
    }
    ...
    Entry entry(buffer.getInt64(consumed + RECORDING_ID_OFFSET),
                ...
                buffer.getInt32(consumed + SERVICE_ID_OFFSET), type,
                archiveEndpoint, isValid, position, m_nextEntryIndex);
...
inline void RecordingLog::writeEntryToBuffer(const Entry &entry,
                                             AtomicBuffer &buffer) {
...
inline void RecordingLog::persistToStorage(std::int64_t entryPosition,
                                           std::int32_t offset,
                                           std::int32_t length) {
  if (!m_fileStream.is_open()) {
...
inline void RecordingLog::persistToStorage(const Entry &entry,
  ...
  if (aeron::NULL_VALUE == entryPosition) {
    ...
    entryPosition = BitUtil::align(currentSize,
                                   static_cast<std::int64_t>(RECORD_ALIGNMENT));
  }
  ...
  m_fileStream.write(reinterpret_cast<const char *>(directBuffer.buffer()),
                     entryLength);
...
inline std::int32_t
RecordingLog::append(std::int32_t entryType, std::int64_t recordingId,
                     std::int64_t leadershipTermId,
                     std::int64_t termBaseLogPosition, std::int64_t logPosition,
                     std::int64_t timestamp, std::int32_t serviceId,
  ...
  for (int i = static_cast<int>(m_entriesCache.size()) - 1; i >= 0; i--) {
    ...
    if (entry.leadershipTermId < e.leadershipTermId ||
        (entry.leadershipTermId == e.leadershipTermId &&
         entry.termBaseLogPosition < e.termBaseLogPosition) ||
        (entry.leadershipTermId == e.leadershipTermId &&
         entry.termBaseLogPosition == e.termBaseLogPosition &&
...
inline RecordingLog::Entry *
RecordingLog::getLatestSnapshot(std::int32_t serviceId) {
  const std::int32_t CONSENSUS_MODULE_SERVICE_ID =
      aeron::NULL_VALUE; // ConsensusModuleAgent::SERVICE_ID

  for (int i = static_cast<int>(m_entriesCache.size()) - 1; i >= 0; i--) {
    Entry &entry = m_entriesCache[i];
    if (isValidSnapshot(entry) &&
        CONSENSUS_MODULE_SERVICE_ID == entry.serviceId) {
...
inline std::int64_t
RecordingLog::getTermTimestamp(std::int64_t leadershipTermId) const {
  auto it = m_cacheIndexByLeadershipTermIdMap.find(leadershipTermId);
  if (it != m_cacheIndexByLeadershipTermIdMap.end()) {
...
inline void RecordingLog::invalidateEntry(std::int32_t index) {
  ...
  } else if (ENTRY_TYPE_SNAPSHOT == invalidEntry.type ||
             ENTRY_TYPE_STANDBY_SNAPSHOT == invalidEntry.type) {
    m_invalidSnapshots.push_back(index);
  }

  const std::int32_t invalidEntryType =
      ENTRY_TYPE_INVALID_FLAG | invalidEntry.type;
...
inline std::map<std::string, std::vector<RecordingLog::Entry>>
RecordingLog::latestStandbySnapshots(std::int32_t serviceCount) {
  std::map<std::string, std::map<std::int64_t, std::vector<Entry>>>
      standbySnapshots;

  for (int i = static_cast<int>(m_entriesCache.size()) - 1; i >= 0; i--) {
    Entry &entry = m_entriesCache[i];
    if (ENTRY_TYPE_STANDBY_SNAPSHOT == entry.type && entry.isValid) {
      standbySnapshots[entry.archiveEndpoint][entry.logPosition].push_back(
          entry);
    }
  }
...
inline void RecordingLog::addSnapshots(std::vector<Snapshot> &snapshots,
                                       const std::vector<Entry> &entries,
                                       std::int32_t serviceCount,
                                       std::int32_t snapshotIndex) {
  const Entry &snapshot = entries[snapshotIndex];
  snapshots.push_back(Snapshot(snapshot.recordingId, snapshot.leadershipTermId,
...
inline void RecordingLog::planRecovery(std::vector<Snapshot> &snapshots,
                                       std::shared_ptr<Log> &logRef,
                                       const std::vector<Entry> &entries,
                                       std::shared_ptr<AeronArchive> archive,
                                       std::int32_t serviceCount,
  ...
  if (entries.empty()) {
    if (aeron::NULL_VALUE != replicatedRecordingId) {
      ...
      recording_descriptor_consumer_t consumer =
          [&recordingExtent](RecordingDescriptor &desc) {
            recordingExtent.onRecordingDescriptor(
                desc.m_controlSessionId, desc.m_correlationId,
                desc.m_recordingId, desc.m_startTimestamp, desc.m_stopTimestamp,
                desc.m_startPosition, desc.m_stopPosition, desc.m_initialTermId,
                desc.m_segmentFileLength, desc.m_termBufferLength,
                desc.m_mtuLength, desc.m_sessionId, desc.m_streamId,
                desc.m_strippedChannel, desc.m_originalChannel,
      ...
      logRef = std::make_shared<Log>(
          replicatedRecordingId, aeron::NULL_VALUE, 0, 0,
          recordingExtent.startPosition, recordingExtent.stopPosition,
          recordingExtent.initialTermId, recordingExtent.termBufferLength,
          recordingExtent.mtuLength, recordingExtent.sessionId);
    }
  ...
  for (int i = static_cast<int>(entries.size()) - 1; i >= 0; i--) {
    ...
    if (-1 == snapshotIndex && isValidSnapshot(entry) &&
      ...
      snapshotIndex = i;
    } else if (-1 == logIndex && isValidTerm(entry) &&
               aeron::NULL_VALUE != entry.recordingId) {
      logIndex = i;
  ...
  if (-1 != logIndex) {
    ...
    recording_descriptor_consumer_t consumer = [&recordingExtent](
      ...
      recordingExtent.onRecordingDescriptor(
          ...
          desc.m_startTimestamp, desc.m_stopTimestamp, desc.m_startPosition,
          desc.m_stopPosition, desc.m_initialTermId, desc.m_segmentFileLength,
          desc.m_termBufferLength, desc.m_mtuLength, desc.m_sessionId,
          desc.m_streamId, desc.m_strippedChannel, desc.m_originalChannel,
          desc.m_sourceIdentity);
    };
    ...
    const std::int64_t startPosition = (-1 == snapshotIndex)
                                           ...
                                           : snapshots[0].logPosition;

    logRef = std::make_shared<Log>(
        entry.recordingId, entry.leadershipTermId, entry.termBaseLogPosition,
        entry.logPosition, startPosition, recordingExtent.stopPosition,
        recordingExtent.initialTermId, recordingExtent.termBufferLength,
        recordingExtent.mtuLength, recordingExtent.sessionId);
  }
}

inline RecordingLog::RecoveryPlan
RecordingLog::createRecoveryPlan(std::shared_ptr<AeronArchive> archive,
                                 std::int32_t serviceCount,
                                 std::int64_t replicatedRecordingId) {
  std::vector<Snapshot> snapshots;
  std::shared_ptr<Log> logRef;
  planRecovery(snapshots, logRef, m_entriesCache, archive, serviceCount,
  ...
  return RecoveryPlan(lastLeadershipTermId, lastTermBaseLogPosition,
                      appendedLogPosition, committedLogPosition, snapshots,
                      logRef);
}

inline void RecordingLog::ensureCoherent(
    std::int64_t recordingId, std::int64_t initialLogLeadershipTermId,
    std::int64_t initialTermBaseLogPosition, std::int64_t leadershipTermId,
    std::int64_t termBaseLogPosition, std::int64_t logPosition,
    std::int64_t nowNs, std::int64_t timestamp, std::int32_t fileSyncLevel) {
  validateTermRecordingId(recordingId);
  ...
  if (entry->recordingId != recordingId ||
    ...
    throw client::ClusterException(
        "recording log entry mismatch: expected recordingId=" +
            ...
            " termBaseLogPosition=" +
            std::to_string(entry->termBaseLogPosition) +
  ...
  if (entry->timestamp != timestamp) {
    ...
    m_entriesCache[m_cacheIndexByLeadershipTermIdMap[leadershipTermId]] =
        updatedEntry;
  }
